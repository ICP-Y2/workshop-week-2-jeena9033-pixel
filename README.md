...
We observed that when 1.5 V of battery is connected in the series connection, the multimeter showed overall voltage of 6 V.
Hence, when the batteries are connected in the series, the overall voltage across the circuit is the sum of the voltage of batteries.
```
...
We observed that when four 1.5 V of battery is connected in the parallel connection, the multimeter showed overall voltage is 1.5 V.
Hence, Batteries are connected in the parallel, the overall voltage will be the same of the volatage of the batteries. 
...
We observed that light will be sparked brightly.When the resistor is kept at 1 kilo ohm led light sparked less, and when the resistor is kept at 6 kilo ohm led light will be damaged. Hence, we observed that when the resistance of resistor decreases the current will be increases. Resistance are current are inversely proportional to each other.  
...
a.	R2: _____4 ohms ___________ V: ______20 V_______    Measured Voltage: ___16 V_____________

b.	R2: _________3 Ohms_______ V: ____25 V_________    Measured Voltage: _____18.7 V___________

c.	R2: ______7 ohms__________ V: _____7 V________    Measured Voltage: ____6.12 V____________
